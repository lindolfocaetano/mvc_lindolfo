...
function (kernel,
    ...
    kernel.experimental("EGL.widget.Standby");

    return declare("EGL.widget.Standby", [_Widget, _TemplatedMixin], {
        // summary:
        ...
        templateString:
            "<div>" +
                ...
                "<div dojoAttachPoint=\"_centerNode\" style=\"opacity: 0; display: none; z-index: -10000;position: absolute; top: 0px; left: 0px; cursor:wait; text-align:center;\" >" +
                    "<img src=\"${image}\" dojoAttachPoint=\"_imageNode\">" +
                    "<b><div dojoAttachPoint=\"_textNode\"></div></b>" +
                "</div>" +
            "</div>",
